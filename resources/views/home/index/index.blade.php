            ...
            <div class="col-xs-12 col-md-12 col-lg-12 b-date">
                <ul class="row">
                    ...
                    <li class="col-xs-5 col-md-2 col-lg-2">
                        <i class="fa fa-list-alt"></i> <a href="http://localhost:8000/category/1" target="_blank">{{ $v->category->name }}</a>
                    </li>
                    <li class="col-xs-7 col-md-5 col-lg-4 "><i class="fa fa-tags"></i>
                        @foreach($v->tags as $t)
                        <a class="b-tag-name" href="http://localhost:8000/tag/1" target="_blank">{{ $t->name }}</a>
                        @endforeach
                    </li>
                </ul>
            </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 hidden-xs b-oa-thumbnail">
                        <figure class="b-oa-pic b-style1">
                            <a href="{{ url('article',[$v->id]) }}" target="_blank">
                                <img src="{{ $v->cover }}" alt="Yinzh博客" title="Yinzh博客">
                            </a>
                            <figcaption>
